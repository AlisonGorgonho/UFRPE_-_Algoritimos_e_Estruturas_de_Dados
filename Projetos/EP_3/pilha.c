...
//Criação da estrutura TipoCelula, responsavel por armazenar nosso valor e o ponteiro para o proximo elemento da pilha
struct TipoCelula{
    char x;
...
//Função PUSH, responsavel por inserir elementos na nossa pilha, primeiriamente recebemos como parametros x, criamos um novo ponterio do tipo TipoCelula, e alocamos o espaço necessario para ele.
